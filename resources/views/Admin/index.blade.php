      ...
      $(function() {
        ...
        if ($("#sales-chart-b").length) {
          ...
          var salesChartBChart = new Chart(salesChartBChartCanvas, {
            type: 'bar',
            data: {
              labels: ['AA', 'AB', 'AC', 'AD', 'AF', 'AG', 'AH', 'AI', 'AJ', 'AK', 'AL', 'AM', 'AN', 'AO', 'AP',
                'AQ', 'AR', 'AS', 'AT', 'AU', 'AW', 'AX', 'AY', 'AZ', 'BA', 'BB', 'BC', 'BD'
              ],
              datasets: [{
                label: 'Profit',
                ...
                backgroundColor: ['#3b86d1', '#3b86d1', '#3b86d1', '#3b86d1', '#3b86d1', '#3b86d1',
                  '#3b86d1', '#3b86d1', '#3b86d1', '#3b86d1', '#3b86d1', '#3b86d1', '#3b86d1', '#3b86d1',
                  '#3b86d1', '#3b86d1', '#3b86d1', '#3b86d1', '#3b86d1', '#3b86d1', '#3b86d1', '#3b86d1',
                  '#3b86d1', '#b4d5f6', '#b4d5f6', '#b4d5f6', '#b4d5f6', '#b4d5f6'
                ]
              }]
            },
            options: {
            ...
            data: {
              ...
              datasets: [{
                ...
                backgroundColor: ['#3b86d1', '#3b86d1', '#3b86d1', '#3b86d1', '#3b86d1', '#3b86d1',
                  '#3b86d1', '#3b86d1', '#3b86d1', '#3b86d1', '#3b86d1', '#3b86d1', '#3b86d1', '#3b86d1',
                  '#3b86d1', '#3b86d1', '#3b86d1', '#3b86d1', '#3b86d1', '#3b86d1', '#3b86d1', '#3b86d1',
                  '#3b86d1', 'rgba(180, 213, 246, .8)', 'rgba(180, 213, 246, .8)',
                  'rgba(180, 213, 246, .8)', 'rgba(180, 213, 246, .8)', 'rgba(180, 213, 246, .8)'
                ]
              }]
            },
            options: {
        ...
        if ($("#desktop-chart").length) {
          ...
          var areaOptions = {
            ...
            legendCallback: function(chart) {
              ...
              text.push(
                '<div class="me-2" style="width: 10px; height: 10px; border-radius: 50%;  background: ' +
                chart.data.datasets[0].backgroundColor[0] + ' "></div>');
              text.push('<p class="mb-0">Desktop&nbsp;(24%)</p>')
              text.push('</div>');
              text.push('<div class="d-flex align-items-center mb-3">');
              text.push('<div class="me-2" style="width: 10px; height: 10px; border-radius: 50%; background: ' +
                chart.data.datasets[0].backgroundColor[1] + ' "></div>');
              text.push('<p class="mb-0">Mobile&nbsp;(26%)</p>')
              text.push('</div>');
              text.push('<div class="d-flex align-items-center">');
              text.push('<div class="me-2" style="width: 10px; height: 10px; border-radius: 50%; background: ' +
                chart.data.datasets[0].backgroundColor[2] + ' "></div>');
        ...
        if ($('#income-chart').length) {
          ...
          var options = {
            ...
            legendCallback: function(chart) {
              ...
              text.push(
                '<div class="me-2" style="width: 12px; border-radius: 50%; height: 12px; background-color: ' +
                chart.data.datasets[0].borderColor[0] + ' "></div>');
              text.push('<p class="mb-0">Register User</p>');
              text.push('</div>');
              text.push('<div class="d-flex align-items-center">');
              text.push(
                '<div class="me-2" style="width: 12px; border-radius: 50%; height: 12px; background-color: ' +
                chart.data.datasets[1].borderColor[0] + ' "></div>');
            ...
            options: {
              ...
              legendCallback: function(chart) {
                ...
                for (var i = 0; i < chart.data.datasets[0].data.length; i++) {
                  text.push('<li><span class="legend-dots" style="background-color:' + chart.data.datasets[0]
                    .backgroundColor[i] + '"></span>');
        ...
        if ($("#expense-chart").length) {
          ...
          var expenseChart = new Chart(expenseChartCanvas, {
            ...
            data: {
              ...
              datasets: [{
                  label: 'Profit',
                  data: [35, 38, 29, 35, 37, 38, 24, 28, 19, 33, 42, 48, 33, 33, 29, 27, 29, 38, 31, 28, 23,
                    24
                  ],
                  backgroundColor: '#a43cda',
                },
        ...
        document.querySelector('#bannerClose').addEventListener('click', function() {
          ...
          $.cookie('polluxui-pro-banner', "true", {
            expires: date
          });
        });
