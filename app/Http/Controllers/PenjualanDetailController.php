...
class PenjualanDetailController extends Controller
{
    public function index()
    {
        ...
        if ($id_penjualan = session('id_penjualan')) {
            ...
            return view('admin.penjualan_detail.index', compact('produk', 'member', 'diskon', 'id_penjualan', 'penjualan', 'memberSelected'), $data);
        } else {
            ...
            // }
            return redirect()->route('transaksi.baru');
            // return view('admin.penjualan_detail.index', $data);
        }
    }
